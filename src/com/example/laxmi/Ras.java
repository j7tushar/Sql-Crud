...
public class Ras extends Activity  implements OnClickListener,OnItemSelectedListener,OnRatingBarChangeListener
{
	EditText ed;
	Button btn;
	RadioGroup rg;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		adapter=ArrayAdapter.createFromResource(Ras.this, R.array.Sp, android.R.layout.simple_spinner_item);
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);
		sp.setAdapter(adapter);
		sp.setOnItemSelectedListener(this);
		
		b=getIntent().getExtras();
		String ab=b.getString("key");
		def=Integer.parseInt(ab);
		t.setText(ab);
	...
	public void onClick(View arg0)
	{
		...
		if(btn==arg0)
		{
			...
			Intent i=new Intent(Ras.this,Sas.class);
			startActivity(i);
